...
### 🏛️ Applications Municipales — [Mairie de Saint-Jean-Cap-Ferrat](https://github.com/mairie-de-saint-jean-cap-ferrat)
...
- **[Commerce App v2](https://github.com/yonix06/commerce-app-v2)** - Plateforme e-commerce basée sur MedusaJS
...
## 🏢 Organisation — [Mairie de Saint-Jean-Cap-Ferrat](https://github.com/mairie-de-saint-jean-cap-ferrat)

Repos publics notables de l'organisation :

- **[Wazuh-Rules](https://github.com/mairie-de-saint-jean-cap-ferrat/Wazuh-Rules)** - Règles avancées de détection Wazuh
  - 🛡️ Rulesets étendus pour Sysmon, Office365, Defender, MISP, Suricata, Yara, Falco…
  - 📜 Licence MIT

- **[basic-env](https://github.com/mairie-de-saint-jean-cap-ferrat/basic-env)** - Templates Coder pour environnements de développement
  - 🐳 Environments prêts-à-l'emploi : JS, TS, PHP, Java, Python, Dart
  - 🖥️ VS Code Server + accès VNC (XFCE) + dotfiles

- **[base-nextjs](https://github.com/mairie-de-saint-jean-cap-ferrat/base-nextjs)** - Boilerplate Next.js (Marblism)
...
**"Cut the crap, Think Penguin"** 🐧

[![GitHub followers](https://img.shields.io/github/followers/yonix06?style=social)](https://github.com/yonix06)
[![GitHub stars](https://img.shields.io/github/stars/yonix06?style=social)](https://github.com/yonix06)
